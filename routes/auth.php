...
Route::get('/profile/@{username}', [AccountController::class, 'profile2'])
                ->name('profile');
Route::get('/profile2/@{username}', [AccountController::class, 'profile'])
                ->name('profile2');
                

Route::get('/profile/@{username}/comments', [AccountController::class, 'user_comments'])
                ->name('user_comments');
Route::get('/profile/@{username}/posted', [AccountController::class, 'user_posted'])
->name('user_posted');
