        ...
        <ul class="music-lists m-0 p-0">
            <li class="d-flex mb-4 align-items-center">
                <div class="media-support-info ml-3">
                    <h4>{{ __('main.w_user') }}</h4>
                </div>
                <div class="music-time">{{ __('main.w_score') }}</div>
            </li>
            <hr>
            @forelse($topUser as $user)
            <li class="d-flex mb-4 align-items-center">
                ...
                <div class="media-support-info ml-3">
                    <a href="{{ route('profile', $user->name) }}" class="link-primary text-decoration-none strong">
                        <h4 class="text-primary">{{ $user->name }}</h4>
                    </a>
                </div>

                <div class="music-time"> {{ $user->total_point_count() }}</div>
            </li>
            @empty
            <li class="d-flex mb-4 align-items-center">
                <div class="empty">
